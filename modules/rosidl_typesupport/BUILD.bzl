...
cc_library(
    ...
    srcs = glob([
        "rosidl_typesupport_c/src/*.c",
    ]),
    hdrs = glob([
        "rosidl_typesupport_c/include/**/*.h",
    ]),
    includes = [
...
cc_library(
    ...
    includes = [
        "rosidl_typesupport_cpp/include",
    ],
    deps = [
...
py_library(
    ...
    srcs = [
        "rosidl_typesupport_c/rosidl_typesupport_c/__init__.py",
    ],
    imports = [
        "rosidl_typesupport_c",
    ],
...
py_binary(
    ...
    srcs = [
        _ROSIDL_TYPESUPPORT_GENERATOR_C_APP_PY,
    ],
    main = _ROSIDL_TYPESUPPORT_GENERATOR_C_APP_PY,
    deps = [
        ":rosidl_typesupport_generator_c_lib",
    ],
    visibility = ["//visibility:public"],
)
filegroup(
    ...
    srcs = glob([
        "rosidl_typesupport_c/resource/*.em",
    ]),
    visibility = ["//visibility:public"],
)
exports_files([
...
py_library(
    ...
    srcs = [
        "rosidl_typesupport_cpp/rosidl_typesupport_cpp/__init__.py",
    ],
    imports = [
...
py_binary(
    ...
    srcs = [
        _ROSIDL_TYPESUPPORT_GENERATOR_CPP_APP_PY,
    ],
    main = _ROSIDL_TYPESUPPORT_GENERATOR_CPP_APP_PY,
    deps = [
        ":rosidl_typesupport_generator_cpp_lib",
    ],
    visibility = ["//visibility:public"],
)
filegroup(
    ...
    srcs = glob([
        "rosidl_typesupport_cpp/resource/*.em",
    ]),
    visibility = ["//visibility:public"],
)
